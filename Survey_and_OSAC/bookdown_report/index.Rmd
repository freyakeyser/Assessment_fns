...
header-includes:
 ...
 - \usepackage{fancyhdr}
 - \pagestyle{fancy}
 - \fancyfoot[CO,CE]{Spring Survey 2026}
...
dates <- summary_data$dates[summary_data$dates$bank %in% c(#"Mid", "Sab", 
  "Ger", #"BBs",
          "BBn", "GB"),]
```
...
The Spring Offshore Scallop Survey occurred from `r stamp("March 1")(min(dates$start)-days(1))` to `r stamp("March 1, 2021")(max(dates$end) + days(1))` on German Bank, Browns Bank North, and the Georges Bank monitoring stations. The Chief Scientist was Tricia Pearo Drew, and the survey was carried out on the Fundy Leader. Surveys of Browns Bank South, Banquereau, Middle and Sable Banks did not occur in the spring of 2026.
