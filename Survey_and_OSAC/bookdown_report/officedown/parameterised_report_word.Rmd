...
if(all(as.character(ntows$Var1[ntows$bank==params$bank]) == c(1,2,5)) & !params$bank == "Ger") surv.description <- paste0(ntows$Freq[ntows$bank==params$bank & ntows$Var1==1], " ", bank$towtype1[bank$lab==params$bank],  " stations within the survey domain, and ", sum(ntows$Freq[ntows$bank==params$bank & !ntows$Var1==1]), " exploratory stations.")
