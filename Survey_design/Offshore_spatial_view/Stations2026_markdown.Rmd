...
bank <- "BBn" # to do: Sab, Ger, Ban, GBa, GBb
year <- 2026 # this is for the folder save location
survey_years <- 2025 # choose one year only (most recent will contain past years)
fishery_years <- 2024:2025 # choose multiple years. must be a year in which fishing occurred
station_years <- 2026
seeds=71805:(71805+4)
...
direct_data <- "C:/Users/keyserf/Documents/temp_data/"
#load the data
